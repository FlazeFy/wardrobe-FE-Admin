import { initSelect } from './wash_stats_select_component.js'
...
async function renderChart(context) {
    ...
    try {
        const res = await loadStats('wash', context, 'd4dbb0d3-8a96-489b-b86c-8bb77c4aea21')
        const data = res.data
        ...
        const options = {
            ...
            title: {
                text: `Most Context Wash - ${context.replace(/_/g, ' ')}`
            }
        }
